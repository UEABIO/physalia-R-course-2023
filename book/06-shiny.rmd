...
```{r modules-demo-app, eval=FALSE, echo=FALSE, fig.cap="Modules Demo App. You can also access this app with `shinyintro::app(\"modules_demo\")`or view it in a separate tab with the [showcase interface](https://shiny.psy.gla.ac.uk/debruine/modules_demo/){target=\"_blank\"}."}
if (is_html)
