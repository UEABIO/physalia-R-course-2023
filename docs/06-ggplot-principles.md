...
data_color(colors = c("#FEF0D9", "#990000"), domain = c(0,30))
```
...
<img src="06-ggplot-principles_files/figure-html/unnamed-chunk-89-1.png" width="100%" style="display: block; margin: auto;" />
</div></div></div>
