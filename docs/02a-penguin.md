...
<div class='webex-radiogroup' id='radio_KEDVXVTDJM'><label><input type="radio" autocomplete="off" name="radio_KEDVXVTDJM" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_KEDVXVTDJM" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_KEDVXVTDJM" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_KEDVXVTDJM" value="answer"></input> <span>dmy()</span></label></div>
