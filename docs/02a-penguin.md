...
<div class='webex-radiogroup' id='radio_VZSHFRZOPP'><label><input type="radio" autocomplete="off" name="radio_VZSHFRZOPP" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_VZSHFRZOPP" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_VZSHFRZOPP" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_VZSHFRZOPP" value="answer"></input> <span>dmy()</span></label></div>
