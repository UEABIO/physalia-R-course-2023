...
<div class='webex-radiogroup' id='radio_ZSTXJCKZON'><label><input type="radio" autocomplete="off" name="radio_ZSTXJCKZON" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_ZSTXJCKZON" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_ZSTXJCKZON" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_ZSTXJCKZON" value="answer"></input> <span>dmy()</span></label></div>
