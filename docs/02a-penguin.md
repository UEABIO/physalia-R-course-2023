...
<div class='webex-radiogroup' id='radio_LYQYQWKIAS'><label><input type="radio" autocomplete="off" name="radio_LYQYQWKIAS" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_LYQYQWKIAS" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_LYQYQWKIAS" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_LYQYQWKIAS" value="answer"></input> <span>dmy()</span></label></div>
