...
<div class='webex-radiogroup' id='radio_FOZCAMPGPN'><label><input type="radio" autocomplete="off" name="radio_FOZCAMPGPN" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_FOZCAMPGPN" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_FOZCAMPGPN" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_FOZCAMPGPN" value="answer"></input> <span>dmy()</span></label></div>
