...
<div class='webex-radiogroup' id='radio_RSZNVEBSWB'><label><input type="radio" autocomplete="off" name="radio_RSZNVEBSWB" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_RSZNVEBSWB" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_RSZNVEBSWB" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_RSZNVEBSWB" value="answer"></input> <span>dmy()</span></label></div>
