...
<div class='webex-radiogroup' id='radio_ETUUFYQSUT'><label><input type="radio" autocomplete="off" name="radio_ETUUFYQSUT" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_ETUUFYQSUT" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_ETUUFYQSUT" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_ETUUFYQSUT" value="answer"></input> <span>dmy()</span></label></div>
