...
<p>Why not try and set up a project on Github and open it on RStudio
Cloud?</p>
<p>First - go to (https://github.com) and log in.</p>
<p>Near repositories click the big green “New” button.</p>
<p>Set it to no template, give it a name like “Learning R
functions”.</p>
<p>Initialise the project with a README and create repository</p>
<p>Click on the green “Code” button to get the link to Clone the
repository into RStudio Cloud.</p>
</div>
...
<tbody>
  <tr>
   ...
   <td style="text-align:right;"> 0.2305106 </td>
  </tr>
</tbody>
</table>
...
<div class="info">
<p>Functions are about ‘abstracting’ a command, so it can be used more
than once. If you are having trouble writing a function, start by
writing a standard set of commands as you would to solve a specific
problem. Then work backwards to turn this into a function.</p>
</div>
