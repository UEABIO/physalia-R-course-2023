...
<div class='webex-radiogroup' id='radio_NRJESDEBOL'><label><input type="radio" autocomplete="off" name="radio_NRJESDEBOL" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_NRJESDEBOL" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_NRJESDEBOL" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_NRJESDEBOL" value="answer"></input> <span>dmy()</span></label></div>
