...
<div class='webex-radiogroup' id='radio_RQXWQFXVIC'><label><input type="radio" autocomplete="off" name="radio_RQXWQFXVIC" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_RQXWQFXVIC" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_RQXWQFXVIC" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_RQXWQFXVIC" value="answer"></input> <span>dmy()</span></label></div>
