...
<div class='webex-radiogroup' id='radio_ZPMTRBMYJJ'><label><input type="radio" autocomplete="off" name="radio_ZPMTRBMYJJ" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_ZPMTRBMYJJ" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_ZPMTRBMYJJ" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_ZPMTRBMYJJ" value="answer"></input> <span>dmy()</span></label></div>
