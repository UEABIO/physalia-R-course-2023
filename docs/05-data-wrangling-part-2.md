...
<div class='webex-radiogroup' id='radio_PYZLGQJNKD'><label><input type="radio" autocomplete="off" name="radio_PYZLGQJNKD" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_PYZLGQJNKD" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_PYZLGQJNKD" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_PYZLGQJNKD" value="answer"></input> <span>dmy()</span></label></div>
