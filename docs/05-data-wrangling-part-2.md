...
<div class='webex-radiogroup' id='radio_CCAWCGXGUQ'><label><input type="radio" autocomplete="off" name="radio_CCAWCGXGUQ" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_CCAWCGXGUQ" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_CCAWCGXGUQ" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_CCAWCGXGUQ" value="answer"></input> <span>dmy()</span></label></div>
