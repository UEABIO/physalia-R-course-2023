...
<div class='webex-radiogroup' id='radio_SKCBGPOTGO'><label><input type="radio" autocomplete="off" name="radio_SKCBGPOTGO" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_SKCBGPOTGO" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_SKCBGPOTGO" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_SKCBGPOTGO" value="answer"></input> <span>dmy()</span></label></div>
