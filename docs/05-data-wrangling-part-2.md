...
<div class='webex-radiogroup' id='radio_CNVPDDTAGV'><label><input type="radio" autocomplete="off" name="radio_CNVPDDTAGV" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_CNVPDDTAGV" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_CNVPDDTAGV" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_CNVPDDTAGV" value="answer"></input> <span>dmy()</span></label></div>
