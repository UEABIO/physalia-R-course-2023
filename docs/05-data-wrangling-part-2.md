...
<div class='webex-radiogroup' id='radio_WDMYFQTQLE'><label><input type="radio" autocomplete="off" name="radio_WDMYFQTQLE" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_WDMYFQTQLE" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_WDMYFQTQLE" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_WDMYFQTQLE" value="answer"></input> <span>dmy()</span></label></div>
