...
<div class='webex-radiogroup' id='radio_TCNZEJKJVY'><label><input type="radio" autocomplete="off" name="radio_TCNZEJKJVY" value=""></input> <span>ymd()</span></label><label><input type="radio" autocomplete="off" name="radio_TCNZEJKJVY" value=""></input> <span>ydm()</span></label><label><input type="radio" autocomplete="off" name="radio_TCNZEJKJVY" value=""></input> <span>mdy()</span></label><label><input type="radio" autocomplete="off" name="radio_TCNZEJKJVY" value="answer"></input> <span>dmy()</span></label></div>
